...
function buildD2Prompt(params: {
  ...
  return [
    ...
    [
      ...
      "",
      "- Exact technical names (function names, event names, enum values) that are still referenced — copy verbatim, never paraphrase.",
      "- Numeric ranges, percentage thresholds, and configuration values — verbatim.",
      "",
      "Drop:",
      "- Session-local operational detail and process mechanics.",
      "- Identifiers that are confirmed superseded and no longer referenced anywhere.",
...
function buildD3PlusPrompt(params: {
  ...
  return [
    ...
    [
      ...
      "- Exact technical names still in effect (function names, event names, enum values) — verbatim.",
      "- Numeric values, ranges, and thresholds that define system behavior — verbatim.",
      "",
      "Drop:",
      "- Operational and process detail.",
      "- Method details unless the method itself was the decision.",
      "- Specific references that are confirmed no longer needed for continuation.",
      "",
